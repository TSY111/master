...
###########################################################################
##contact numbers
connum_intervals <- inner_join(sday, part, by="part_id") %>%
...
levels(connum_intervals$part_age_group)[levels(connum_intervals$part_age_group)=="[18,30)"]=title2
levels(connum_intervals$part_age_group)[levels(connum_intervals$part_age_group)=="[30,40)"]=title3
levels(connum_intervals$part_age_group)[levels(connum_intervals$part_age_group)=="[40,50)"]=title4
levels(connum_intervals$part_age_group)[levels(connum_intervals$part_age_group)=="[50,60)"]=title5
levels(connum_intervals$part_age_group)[levels(connum_intervals$part_age_group)=="[60,70)"]=title6
levels(connum_intervals$part_age_group)[levels(connum_intervals$part_age_group)=="[70,100)"]=title7

connum_intervals$wave=factor(connum_intervals$wave, 
                             levels = wavename1,
                             labels = wavename2)

Fig1=connum_intervals %>% 
