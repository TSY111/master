...
id2=which(conw2$part_id%in%partw2age1$part_id)
id3=which(conw3$part_id%in%partw3age1$part_id)
id4=which(conw4$part_id%in%partw4age1$part_id)
id5=which(conw5$part_id%in%partw5age1$part_id)
id6=which(conw6$part_id%in%partw6age1$part_id)
id7=which(conw7$part_id%in%partw7age1$part_id)
id8=which(conw8$part_id%in%partw8age1$part_id)


conw1age1=conw1[c(id1),]
conw2age1=conw2[c(id2),]
conw3age1=conw3[c(id3),]
conw4age1=conw4[c(id4),]
conw5age1=conw5[c(id5),]
conw6age1=conw6[c(id6),]
conw7age1=conw7[c(id7),]
conw8age1=conw8[c(id8),]
